...
public abstract class SQLTransportIntegrationTest extends ESIntegTestCase {
    ...
    Session createSessionOnNode(String nodeName) {
        ...
        return sqlOperations.createSession(
            sqlExecutor.getDefaultSchema(), User.of("crate", EnumSet.of(User.Role.SUPERUSER)), Option.NONE, SQLTransportExecutor.DEFAULT_SOFT_LIMIT);
    }
    ...
    Session createSession(@Nullable String defaultSchema, Set<Option> options) {
        ...
        return sqlOperations.createSession(defaultSchema, null, options, SQLTransportExecutor.DEFAULT_SOFT_LIMIT);
    }
